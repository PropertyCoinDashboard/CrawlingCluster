...
from parsing.drive.nd_paring_driver import DaumNewsParsingDriver, NaverNewsParsingDriver
...
class CrawlingProcess:
    ...
    async def process_daum(self) -> UrlCollect:
        """daum 크롤링"""
        return await DaumNewsParsingDriver(D_HEADERS, self.target, self.count).extract_news_urls()
